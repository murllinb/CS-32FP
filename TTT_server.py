...
def get_move(active_conn, wait_conn, board, player, dice_choices):
    rolled = False
    while True:
        send(active_conn, f"Player {player}, type 'roll' to roll your dice or 'place' to place your piece.")
        ...
        if decide == 'roll':
            ...
            send(wait_conn, f"Waiting for Player {player} to roll their dice...") ### This isn't properly displaying on the client side
